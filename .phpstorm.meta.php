...
'web','api',);
        registerArgumentsSet('routes', 'tasks.index','tasks.create','folders.create','storage.local',);
        registerArgumentsSet('views', 
'folders.create','layout','tasks.create','tasks.index','welcome',
...
'ja.0','validation.custom.属性名.ルール名','validation.custom.terms.required','validation.attributes.address','validation.attributes.age',
...
'validation.attributes.city','validation.attributes.content','validation.attributes.country','validation.attributes.created_at','validation.attributes.creator',
'validation.attributes.current_password','validation.attributes.date','validation.attributes.date_of_birth','validation.attributes.day','validation.attributes.deleted_at',
'validation.attributes.description','validation.attributes.district','validation.attributes.duration','validation.attributes.email','validation.attributes.excerpt',
...
'validation.attributes.image','validation.attributes.last_name','validation.attributes.lesson','validation.attributes.line_address_1','validation.attributes.line_address_2',
...
'validation.attributes.phone','validation.attributes.photo','validation.attributes.postal_code','validation.attributes.prefecture','validation.attributes.price',
...
'VITE_APP_NAME','SCOUT_DRIVER','MEILISEARCH_HOST','MEILISEARCH_NO_ANALYTICS',);
